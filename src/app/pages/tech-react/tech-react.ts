...
@Component({
  selector: 'app-tech-react',
  standalone: true,
  imports: [],
  templateUrl: './tech-react.html',
  styleUrl: './tech-react.css',
})
export class TechReactComponent implements AfterViewInit, OnDestroy {
  ...
  initScripts() {
    try {
      ...
      console.error('Error initializing scripts for tech-react', e);
    }
  }
}
